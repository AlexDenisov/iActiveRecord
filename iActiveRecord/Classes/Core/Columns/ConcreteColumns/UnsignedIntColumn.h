...
namespace AR {
    template <>
    class ColumnInternal <unsigned int> : public IColumnInternal
    {
    private:
        static unsigned int accessorImpl(ActiveRecord *receiver, SEL _cmd);
        static void mutatorImpl(ActiveRecord *receiver, SEL _cmd, unsigned int value);
    public:
