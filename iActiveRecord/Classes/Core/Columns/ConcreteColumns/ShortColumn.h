...
namespace AR {
    template <>
    class ColumnInternal <short> : public IColumnInternal
    {
    private:
        static short accessorImpl(ActiveRecord *receiver, SEL _cmd);
        static void mutatorImpl(ActiveRecord *receiver, SEL _cmd, short value);
