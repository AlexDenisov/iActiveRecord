...
namespace AR {
    template <>
    class ColumnInternal <unsigned char> : public IColumnInternal
    {
    private:
        static unsigned char accessorImpl(ActiveRecord *receiver, SEL _cmd);
        static void mutatorImpl(ActiveRecord *receiver, SEL _cmd, unsigned char value);
    public:
