...
namespace AR {
    template <>
    class ColumnInternal <unsigned long long> : public IColumnInternal
    {
    private:
        static unsigned long long accessorImpl(ActiveRecord *receiver, SEL _cmd);
        static void mutatorImpl(ActiveRecord *receiver, SEL _cmd, unsigned long long value);
