...
namespace AR {
    template <>
    class ColumnInternal <unsigned long> : public IColumnInternal
    {
    private:
        static unsigned long accessorImpl(ActiveRecord *receiver, SEL _cmd);
        static void mutatorImpl(ActiveRecord *receiver, SEL _cmd, unsigned long value);
