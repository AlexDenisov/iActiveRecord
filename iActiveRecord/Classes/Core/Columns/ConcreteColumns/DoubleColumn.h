...
namespace AR {
    template <>
    class ColumnInternal <double> : public IColumnInternal
    {
    private:
        static double accessorImpl(ActiveRecord *receiver, SEL _cmd);
        static void mutatorImpl(ActiveRecord *receiver, SEL _cmd, double value);
